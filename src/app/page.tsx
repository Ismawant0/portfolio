    ...
    <main className="flex flex-col gap-12">
      ...
      <section id="contact" className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm">
          <Link href="/blog" className="text-zinc-100 border-b border-zinc-800 hover:border-zinc-100 transition-all pb-0.5">
            Blog
          </Link>
          <a href="https://github.com/Ismawant0" target="_blank" rel="noopener noreferrer" className="text-zinc-100 border-b border-zinc-800 hover:border-zinc-100 transition-all pb-0.5">
            GitHub
          </a>
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-zinc-100 border-b border-zinc-800 hover:border-zinc-100 transition-all pb-0.5">
            LinkedIn
          </a>
          <a href="mailto:wantoisma@gmail.com" className="text-zinc-100 border-b border-zinc-800 hover:border-zinc-100 transition-all pb-0.5">
            Email
          </a>
          <a href="https://wa.me/6285399912255" target="_blank" rel="noopener noreferrer" className="text-zinc-100 border-b border-zinc-800 hover:border-zinc-100 transition-all pb-0.5">
            WhatsApp
          </a>
        </div>
      </section>
